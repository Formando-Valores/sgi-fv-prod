...
import { AccessLevel, ProcessStatus, ServiceUnit, User, UserRole } from '../types';
...
const deriveAccessLevel = (isAdmin: boolean): AccessLevel => {
  if (!isAdmin) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        const normalizedAccessLevel = existingUser?.accessLevel ?? deriveAccessLevel(hasAdminRole);
