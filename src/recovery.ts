...
const render = (content: string) => {
  app.innerHTML = `
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;background:#e5e7eb;color:#1e293b;font-family:Arial,sans-serif;">
