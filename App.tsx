...
const RootApp: React.FC = () => {
  ...
  const renderDashboardRoute = (section: 'dashboard' | 'processos' | 'clientes' | 'configuracoes' | 'organizacoes' | 'financeiro' = 'dashboard') => {
    if (!currentUser) {
    ...
    <HashRouter>
      <div className="min-h-screen bg-[#0f172a] text-white font-arial">
        <Routes>
          ...
          <Route path="/dashboard/financeiro" element={renderDashboardRoute('financeiro')} />
